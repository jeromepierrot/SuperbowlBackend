...
import fr.jpierrot.superbowlbackend.ws.ApiRegistration;
...
@Controller
@RequestMapping(MvcRegistration.ROOT
        + ApiRegistration.API_SADMIN) /* default Route => /admin27864/administration...*/
